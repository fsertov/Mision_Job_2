...
function useQueryImpl(document, variables, options = {}, lazy = false) {
  ...
  let firstResolve;
  let firstReject;
  (_b = import_vue_demi5.onServerPrefetch) == null ? void 0 : _b(() => {
    var _a2;
  ...
  function updateRestartFn() {
    ...
    if (!currentOptions) {
      ...
      } else if ((_b2 = currentOptions.value) == null ? void 0 : _b2.debounce) {
  ...
  (0, import_vue_demi5.watch)(() => (0, import_vue_demi5.isRef)(optionsRef) ? optionsRef.value : optionsRef, (value) => {
...
function useMutation(document, options = {}) {
  ...
  (0, import_vue_demi7.onBeforeUnmount)(() => {
    loading.value = false;
  });
  return {
    mutate,
...
function useSubscription(document, variables = void 0, options = {}) {
  ...
  (0, import_vue_demi8.onBeforeUnmount)(stop);
  return {
    result,
    loading,
    error,
