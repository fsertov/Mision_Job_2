...
export declare function useLazyQuery<TResult = any, TVariables = any>(document: DocumentParameter<TResult, TVariables>, variables?: VariablesParameter<TVariables>, options?: OptionsParameter<TResult, TVariables>): {
    load: (document?: DocumentNode | undefined, variables?: TVariables | undefined, options?: UseQueryOptions<any, import("@apollo/client/core").OperationVariables> | undefined) => void;
    ...
    fetchMore: <K extends keyof TVariables>(options: import("@apollo/client/core").FetchMoreQueryOptions<TVariables, K, any> & import("@apollo/client/core").FetchMoreOptions<TResult, TVariables>) => Promise<import("@apollo/client/core").ApolloQueryResult<TResult>> | undefined;
