      ...
      var _loop = function _loop(_i2, _ref2) {
        ...
        if (typeof _this2.initialOptions[prop] === 'function') {
          ...
          if (!_this2.vm.$isServer) {
            cb = _this2.options.throttle ? throttle(cb, _this2.options.throttle) : cb;
            cb = _this2.options.debounce ? debounce(cb, _this2.options.debounce) : cb;
          }
...
var ApolloProvider = /*#__PURE__*/function () {
  ...
  _createClass(ApolloProvider, [{
    ...
    value: function install(app) {
      // Options merging
      var merge = app.config.optionMergeStrategies.methods;
